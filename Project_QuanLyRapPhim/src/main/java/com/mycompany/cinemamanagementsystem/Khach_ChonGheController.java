...
public class Khach_ChonGheController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        System.out.println("Đang mở trang đặt vé cho Phim mã số: " + maPhimDangChon);
    ...
    private void xuLyXacNhan() {
        ...
        System.out.println("Mã phim: " + maPhimDangChon);
        System.out.println("Giờ chiếu: " + gioChieu);
        System.out.println("Phòng chiếu: " + phongChieu);
        System.out.println("Ghế đã chọn: " + dsGhe);
    ...
    private void quayLaiTrangTruoc() {
        System.out.println("Quay lại trang Chọn Phim...");
        try {
            App.setRoot("Khach_ChonPhim"); 
        } catch (Exception ex) {
